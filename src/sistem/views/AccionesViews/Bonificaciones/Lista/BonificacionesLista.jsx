...
const TEXTOS = {
   ...
   subtitulo: "Tabla que muestra todos los Bonificaciones disponibles.",
   crearEmpresa: "Crear Bonificacion por Metrica",
};
...
const obtenerColumnasTabla = () => [
   ...
   {
      data: "monto_bonificacion",
      title: "Monto de Compensacion",
      searchPanes: { show: true },
      render: (data) => {
         if (!data) return "";
...
const formatearDatosFila = (datosFila) => ({
   bonificacion_id: datosFila.bonificacion_id,
   ...
   monto_bonificacion: datosFila.monto_bonificacion,
   bonificacion_estado: datosFila.bonificacion_estado,
});
   ...
   const datosEjemplo = [
      {
         ...
         monto_bonificacion: 10000,
         bonificacion_estado: "Activa",
      },
      {
         bonificacion_id: 2,
         ...
         monto_bonificacion: 15000,
         bonificacion_estado: "En Proceso",
      }
   ];
