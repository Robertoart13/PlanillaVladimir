...
const TEXTOS = {
   titulo: "Listado de Planillas Procesadas",
   subtitulo: "solo mostrara la lista para ver los datos por empleados ya procesados",
...
const manejarClicFila = (datosFila, navigate) => {
   ...
   navigate(`/gestor/planillas-empleadosLista?planilla_id=${datosFila.planilla_id}`);
};
 ...
 */
export const PLanillasAplicadas = () => {
   ...
   // Estado fijo para mostrar solo planillas procesadas
   const estadoSeleccionado = "3";
