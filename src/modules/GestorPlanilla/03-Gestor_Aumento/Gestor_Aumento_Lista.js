...
const QUERIES = {
   ...
   FROM 
      gestor_aumento_tbl ga
   INNER JOIN 
      empresas_tbl e ON ga.empresa_id_aumento_gestor = e.id_empresa
   INNER JOIN 
      planilla_tbl p ON ga.planilla_id_aumento_gestor = p.planilla_id
   INNER JOIN 
      usuarios_tbl u ON ga.usuario_id_aumento_gestor = u.id_usuario
   INNER JOIN 
