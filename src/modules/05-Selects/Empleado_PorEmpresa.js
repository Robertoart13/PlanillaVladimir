...
const QUERIES = {
   ...
   QUERIES_SELECT: `
        SELECT * FROM gestor_empleado_tbl WHERE id_empresa = ?
    `,
};
 ...
 * ====================================================================================================================================
 */
const obtenerTodosDatos = async (database, id) => { 
   console.log(id);
   try {
...
const obtenerListaCompleta = async (req, res) => {
   try {
      ...
      const resultado = await obtenerTodosDatos(res?.database, res?.transaccion?.data?.id);
 ...
 * ====================================================================================================================================
 */
const Empleado_PorEmpresa_select = { 
   Empleado_PorEmpresa_select: obtenerListaCompleta, // Método que obtiene la lista completa, con validaciones y permisos.
};

export default Empleado_PorEmpresa_select;
