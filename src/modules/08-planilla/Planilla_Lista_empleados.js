...
const obtenerTodosDatos = async (id_empresa, id_planilla, database) => {
   console.log("Obteniendo todos los datos de la base de datos...", id_empresa, id_planilla);
   try {
      ...
      console.log("Empleados IDs obtenidos:", empleadosIdsArr);
      ...
      console.log("Resultados obtenidos de la base de datos:", resultadoPlanilla, resultadoEmpleados);
