...
const editarTransaccion = async (req, res) => {
   try {
      ...
      const resultado = await editarRegistroBd(res?.transaccion.planilla.formData, res?.database);
 ...
 * ====================================================================================================================================
 */
const Planilla_Incritos = {
   Planilla_Incritos: editarTransaccion,
};

export default Planilla_Incritos;
