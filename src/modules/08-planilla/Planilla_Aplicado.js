 ...
 * ====================================================================================================================================
 */
const editarRegistroBd = async (empleado, planilla_id, database) => {
   return await realizarConsulta(QUERIES.QUERIES_UPDATE, [1, empleado, planilla_id], database);
};
...
const editarTransaccion = async (req, res) => {
   try {
      ...
      const resultado = await editarRegistroBd(
         res?.transaccion.planilla.emeplado,
         res?.transaccion.planilla.planilla_id,
      res?.database);
 ...
 * ====================================================================================================================================
 */
const Planilla_Aplicado = {
   Planilla_Aplicado: editarTransaccion,
};

export default Planilla_Aplicado;
