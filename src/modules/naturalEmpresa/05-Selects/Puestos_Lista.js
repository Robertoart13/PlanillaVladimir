...
const QUERIES = {
   ...
   QUERIES_SELECT: `
        SELECT * FROM puestos_tbl WHERE estado_puesto = 1
    `,
};
 ...
 * ====================================================================================================================================
 */
const Puestos_Listar_select = {
   Puestos_Listar_select: obtenerListaCompleta, // Método que obtiene la lista completa, con validaciones y permisos.
};

export default Puestos_Listar_select;
