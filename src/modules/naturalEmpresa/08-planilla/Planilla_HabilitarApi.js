...
const editarRegistroBd = async (datos, database) => {
   ...
   return await realizarConsulta(QUERIES.QUERIES_UPDATE, [datos.datos.empleado.id_empleado,datos.datos.empleado.planilla_id], database);
};
 ...
 * ====================================================================================================================================
 */
const Planilla_Habilitar = {
   Planilla_Habilitar: editarTransaccion,
};

export default Planilla_Habilitar;
