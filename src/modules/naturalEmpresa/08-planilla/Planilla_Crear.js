...
const QUERIES = {
   QUERIES_INSERT: `
   INSERT INTO planilla_tbl (
      planilla_codigo,      -- Código único de la planilla
      empresa_id,           -- ID de la empresa asociada
      planilla_tipo,        -- Periodicidad (Mensual, Quincenal, etc.)
      planilla_descripcion, -- Descripción opcional
...
const crearTransaccion = async (req, res) => {
   try {
      ...
      const resultado = await crearNuevoRegistroBd(res?.transaccion?.planilla, res?.database);
 ...
 * ====================================================================================================================================
 */
const Planilla_Crear = {
   crearTransaccion,
};

export default Planilla_Crear; 
