...
const QUERIES = {
   ...
   QUERIES_SELECT: `
         SELECT * FROM eventos_tbl where id_evento =?;
...
const obtenerEvento = async (req, res) => {
   try {
      ...
      const resultado = await obtenerTodosDatos(res?.transaccion?.data?.id || 0, res?.database);
 ...
 * ====================================================================================================================================
 */
const Calendario_Evento = {
   obtenerEvento, // Método que obtiene la lista completa, con validaciones y permisos.
};

export default Calendario_Evento;
