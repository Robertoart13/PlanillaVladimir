 ...
 * ====================================================================================================================================
 */
const editarRegistroBd = async (intentos, id_usuario, database) => {
   return await realizarConsulta(QUERIES.QUERIES_UPDATE, [intentos, id_usuario], database);
};
...
const editarTransaccion = async (req, res) => {
   try {
      ...
      const resultado = await editarRegistroBd(
         res?.transaccion?.usuario?.intentos,
 ...
 * ====================================================================================================================================
 */
const Usuario_Reintentos = {
   editarTransaccion,
};

export default Usuario_Reintentos;
