 ...
 * @param {Object} res.transaccion.user - Datos del registro a actualizar, incluyendo su ID.
...
const editarTransaccion = async (req, res) => {
   ...
   try {
      ...
      const resultado = await editarRegistroBd(
         res?.transaccion?.usuario?.verificar,
 ...
 * ====================================================================================================================================
 */
const Usuarios_Verificar = {
   editarTransaccionVerificar: editarTransaccion,
};

export default Usuarios_Verificar;
