 ...
 * ====================================================================================================================================
 */
const editarRegistroBd = async (estado, id_usuario, database) => {
   return await realizarConsulta(QUERIES.QUERIES_UPDATE, [estado, id_usuario], database);
};
...
const editarTransaccion = async (req, res) => {
   try {
      ...
      const resultado = await editarRegistroBd(
         res?.transaccion?.usuario?.estado,
 ...
 * ====================================================================================================================================
 */
const Usuario_CambioEstado = {           
   editarTransaccionEstado: editarTransaccion,
};

export default Usuario_CambioEstado;
