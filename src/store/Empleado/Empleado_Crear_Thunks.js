...
export const Empleado_Crear_Thunks = (formData) => {
      ...
      try {
         ...
         const transaccion = {
            ...
            acceso: {
               type: 0,
               permiso: 0,
               details: "No tiene permisos para crear empleados, ",
            },
         };

         const endpoint = "empleado/crear"; // Endpoint para crear un nuevo empleado
