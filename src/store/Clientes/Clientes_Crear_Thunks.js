...
export const Cliente_Crear_Thunks = (formData) => { 
      ...
      try {
         ...
         const transaccion = {
            ...
            acceso: {
               type: 0,
               permiso: 0,
               details: "No tiene permisos para crear clientes, contacte al administrador del sistema",
            },
         };

         const endpoint = "cliente/crear"; // Endpoint para crear un nuevo cliente
