...
export const Planilla_Lista_Empleado_Thunks = (id_planilla, id_empresa) => {    
      ...
      try {
         ...
         const transaccion = {
            ...
            acceso: {
               ...
               permiso: 0,
               details:
                  "No tiene permisos para listar empleados, contacte al administrador del sistema",
            },
         };

         const endpoint = "planilla/lista_empleado"; // Endpoint para editar una planilla
