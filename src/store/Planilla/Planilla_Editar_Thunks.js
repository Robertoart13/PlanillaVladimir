...
export const Planilla_Editar_Thunks = (formData) => {
      ...
      try {
         ...
         const transaccion = {
            ...
            planilla: {
               ...
               planilla_codigo_viejo: formData.planilla_codigo_viejo,
            ...
            acceso: {
               type: 0,
               permiso: 0,
               details: "No tiene permisos para editar planillas, contacte al administrador del sistema",
            },
         };

         const endpoint = "planilla/editar"; // Endpoint para editar una planilla  
