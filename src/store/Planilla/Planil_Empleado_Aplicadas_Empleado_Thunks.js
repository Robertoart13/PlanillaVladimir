...
export const Planil_Empleado_Aplicadas_Empleado_Thunks = (id_planilla) => {
      ...
      try {
         ...
         const transaccion = {
            ...
            acceso: {
               ...
               permiso: 0,
               details:
                  "No tiene permisos para listar planillas, contacte al administrador del sistema",
            },
         };

         const endpoint = "planilla/lista_empleado_planilla"; // Endpoint para editar una planilla
