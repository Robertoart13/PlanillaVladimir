...
export const Planilla_Aplicado = (emeplado, planilla_id) => {
   return async (dispatch, getState) => {
      try {
         ...
         const transaccion = {
            ...
            planilla: {
               emeplado: emeplado,
               planilla_id: parseInt(planilla_id), // id de la planilla a editar
            },
            acceso: {
               type: 0,
               permiso: 0,
         ...
         const endpoint = "planilla/Planilla_Aplicado"; // Endpoint para editar una planilla
