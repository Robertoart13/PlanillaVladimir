...
export const Planilla_Habilitar = (formData) => {
      ...
      try {
         ...
         const transaccion = {
            ...
            acceso: {
               type: 0,
               permiso: 0,
               details: "No tiene permisos para habilitar planillas, contacte al administrador del sistema",
            },
         };

         const endpoint = "planilla/habilitar"; // Endpoint para editar una planilla  
