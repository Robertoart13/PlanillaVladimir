...
export const Calendario_Evento_Thunks = (data) => {
   return async (dispatch, getState) => {
      try {
         ...
         const transaccion = {
            ...
            data: {
               id: data || 0, // id del evento, si no existe se crea uno nuevo
            },
            acceso: {
               type: 0,
         ...
         const endpoint = "calendario/id"; // Endpoint para obtener la lista de eventos del calendario
