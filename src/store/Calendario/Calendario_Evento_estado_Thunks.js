...
export const Calendario_Evento_estado_Thunks = (id_evento, estado_evento) => {
   ...
   return async (dispatch, getState) => {
      try {
         ...
         const transaccion = {
            ...
            data: {
               id: id_evento || 0, // id del evento, si no existe se crea uno nuevo
               estado: estado_evento || 0, // estado del evento, por defecto 0
            },
            acceso: {
               type: 0,
         ...
         const endpoint = "calendario/estado"; // Endpoint para obtener la lista de eventos del calendario
